...
set "AppNames=!AppNames! Microsoft.WindowsMaps"
set "AppNames=!AppNames! Microsoft.GetHelp"
set "AppNames=!AppNames! Microsoft.BingNews"
set "AppNames=!AppNames! Microsoft.BingWeather"
set "AppNames=!AppNames! Microsoft.PowerAutomateDesktop"

echo.
echo ========= 等待移除 Windows Apps 程序包 =========
